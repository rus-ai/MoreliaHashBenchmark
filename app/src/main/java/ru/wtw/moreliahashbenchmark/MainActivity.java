...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        Spinner algoSelect = findViewById(R.id.spinnerAlgo);
        String selected_val=algoSelect.getSelectedItem().toString();
        ...
        for (degreeCounter = 0; degreeCounter < maxDegreeCount; degreeCounter++ ) {
            ...
            if (selected_val.equals("ALL") || selected_val.equals(algo)) {
